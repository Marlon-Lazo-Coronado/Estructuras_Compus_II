...
gunzip -c branch-trace-gcc.trace.gz | python3 branch.py -s 4 -bp 0 -gh  4 -ph 3 > actual_result.txt
...
gunzip -c branch-trace-gcc.trace.gz | python3 branch.py -s 5 -bp 1 -gh  4 -ph 3 > actual_result.txt
...
gunzip -c branch-trace-gcc.trace.gz | python3 branch.py -s 5 -bp 2 -gh  4 -ph 3 > actual_result.txt
...
gunzip -c branch-trace-gcc.trace.gz | python3 branch.py -s 5 -bp 3 -gh  5 -ph 3 > actual_result.txt
